                ...
                <div class="card border shadow-lg mb-4">
                    <div class="card-header border-bottom pb-0">
                        <div class="d-sm-flex align-items-center">
                            <div>
                                <h6 class="font-weight-semibold text-lg mb-0">List Data Nilai</h6>
                                <p class="text-sm"></p>
                            </div>
                            <div class="ms-auto d-flex">
                                <a href="/dashboard/data-nilai/create" type="button"
                            ...
                            <table class="table table-hover align-items-center mb-0">
                                <thead class="bg-gray-100">
                                    <tr>
                                        ...
                                        <th class="text-secondary  text-xs font-weight-semibold opacity-7 ps-2">Nama Siswa
                                        </th>
                                        <th class="text-secondary  text-xs font-weight-semibold opacity-7 ps-2">Mata
                                            Pelajaran
                                        </th>
                                        <th class="text-secondary text-center text-xs font-weight-semibold opacity-7">Nilai
                                        </th>
                                    ...
                                    @forelse ($nilai as $item)
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <span
                                                    class="text-secondary text-sm font-weight-normal">{{ $item->siswa->nama }}</span>
                                            </td>
                                            <td class="align-middle">
                                                <span
                                                    class="text-secondary text-sm font-weight-normal">{{ $item->pelajaran->nama }}</span>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span
                                                    class="text-secondary text-sm font-weight-normal">{{ $item->nilai }}</span>
                                            </td>
            ...
            <div class="modal-dialog ">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="/dashboard/data-nilai/{{ $item->id }}" method="POST">
                            @method('DELETE')
                            @csrf
